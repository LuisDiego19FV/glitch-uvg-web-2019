...
const logoCode = logoInstance.render();

const cuadroInstance = new Cuadro();
const cuadroCode = cuadroInstance.render();

const inputInstance = new Input();
const inputCode = inputInstance.render();

const scrollInstance = new ScrollButton();
const scrollCode = scrollInstance.render();
